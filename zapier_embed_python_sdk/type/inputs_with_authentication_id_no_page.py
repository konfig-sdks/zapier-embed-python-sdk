...
class RequiredInputsWithAuthenticationIdNoPage(TypedDict):
    pass

class OptionalInputsWithAuthenticationIdNoPage(TypedDict, total=False):
...
class InputsWithAuthenticationIdNoPage(RequiredInputsWithAuthenticationIdNoPage, OptionalInputsWithAuthenticationIdNoPage):
    pass
