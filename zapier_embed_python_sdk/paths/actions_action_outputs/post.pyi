...
from zapier_embed_python_sdk.model.inputs_with_authentication_id_and_fetch_live_samples import InputsWithAuthenticationIdAndFetchLiveSamples as InputsWithAuthenticationIdAndFetchLiveSamplesSchema
...
from zapier_embed_python_sdk.model.actions_get_output_fields_response import ActionsGetOutputFieldsResponse as ActionsGetOutputFieldsResponseSchema
...
from zapier_embed_python_sdk.model.actions_get_output_fields_request import ActionsGetOutputFieldsRequest as ActionsGetOutputFieldsRequestSchema
...
from zapier_embed_python_sdk.type.actions_get_output_fields_request import ActionsGetOutputFieldsRequest
from zapier_embed_python_sdk.type.actions_get_output_fields_response import ActionsGetOutputFieldsResponse
from zapier_embed_python_sdk.type.inputs_with_authentication_id_and_fetch_live_samples import InputsWithAuthenticationIdAndFetchLiveSamples
...
from zapier_embed_python_sdk.pydantic.actions_get_output_fields_response import ActionsGetOutputFieldsResponse as ActionsGetOutputFieldsResponsePydantic
from zapier_embed_python_sdk.pydantic.inputs_with_authentication_id_and_fetch_live_samples import InputsWithAuthenticationIdAndFetchLiveSamples as InputsWithAuthenticationIdAndFetchLiveSamplesPydantic
...
from zapier_embed_python_sdk.pydantic.actions_get_output_fields_request import ActionsGetOutputFieldsRequest as ActionsGetOutputFieldsRequestPydantic
...
# body param
SchemaForRequestBodyApplicationVndApijson = ActionsGetOutputFieldsRequestSchema


request_body_actions_get_output_fields_request = api_client.RequestBody(
    content={
        'application/vnd.api+json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationVndApijson),
    },
)
SchemaFor200ResponseBodyApplicationVndApijson = ActionsGetOutputFieldsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ActionsGetOutputFieldsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_output_fields_mapped_args(
        self,
        action: str,
        data: typing.Optional[InputsWithAuthenticationIdAndFetchLiveSamples] = None,
    ...
    async def _aget_output_fields_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/actions/{action}/outputs',
            body=body,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_actions_get_output_fields_request.serialize(body, content_type)
...
class GetOutputFieldsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_output_fields(
        self,
        action: str,
        data: typing.Optional[InputsWithAuthenticationIdAndFetchLiveSamples] = None,
        **kwargs,
        ...
        args = self._get_output_fields_mapped_args(
            action=action,
            data=data,
        )
        return await self._aget_output_fields_oapg(
            body=args.body,
    ...
    def get_output_fields(
        ...
        return self._get_output_fields_oapg(
            body=args.body,
            path_params=args.path,
        )

class GetOutputFields(BaseApi):
    ...
    async def aget_output_fields(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ActionsGetOutputFieldsResponsePydantic:
        raw_response = await self.raw.aget_output_fields(
            action=action,
            data=data,
            **kwargs,
        )
        if validate:
            return ActionsGetOutputFieldsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ActionsGetOutputFieldsResponsePydantic, raw_response.body)
    ...
    def get_output_fields(
        ...
        raw_response = self.raw.get_output_fields(
            action=action,
            data=data,
        )
        if validate:
