...
from zapier_embed_python_sdk.model.actions_get_choices_response import ActionsGetChoicesResponse as ActionsGetChoicesResponseSchema
...
from zapier_embed_python_sdk.model.actions_get_choices_request_data import ActionsGetChoicesRequestData as ActionsGetChoicesRequestDataSchema
from zapier_embed_python_sdk.model.actions_get_choices_request import ActionsGetChoicesRequest as ActionsGetChoicesRequestSchema
...
from zapier_embed_python_sdk.type.actions_get_choices_request import ActionsGetChoicesRequest
...
from zapier_embed_python_sdk.type.actions_get_choices_response import ActionsGetChoicesResponse

from ...api_client import Dictionary
from zapier_embed_python_sdk.pydantic.actions_get_choices_request_data import ActionsGetChoicesRequestData as ActionsGetChoicesRequestDataPydantic
...
from zapier_embed_python_sdk.pydantic.actions_get_choices_response import ActionsGetChoicesResponse as ActionsGetChoicesResponsePydantic
from zapier_embed_python_sdk.pydantic.actions_get_choices_request import ActionsGetChoicesRequest as ActionsGetChoicesRequestPydantic
...
InputSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'action': typing.Union[ActionSchema, str, ],
        'input': typing.Union[InputSchema, str, ],
    }
)
...
request_path_input = api_client.PathParameter(
    name="input",
    style=api_client.ParameterStyle.SIMPLE,
    schema=InputSchema,
    required=True,
...
# body param
SchemaForRequestBodyApplicationVndApijson = ActionsGetChoicesRequestSchema


request_body_actions_get_choices_request = api_client.RequestBody(
    content={
        'application/vnd.api+json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationVndApijson),
    },
)
SchemaFor200ResponseBodyApplicationVndApijson = ActionsGetChoicesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ActionsGetChoicesResponse
    ...
    async def _aget_choices_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/actions/{action}/inputs/{input}/choices',
            body=body,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_actions_get_choices_request.serialize(body, content_type)
...
class GetChoicesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_choices(
        self,
        data: ActionsGetChoicesRequestData,
        action: str,
        input: str,
        ...
        **kwargs,
        ...
        args = self._get_choices_mapped_args(
            data=data,
            action=action,
            input=input,
            page=page,
        )
        return await self._aget_choices_oapg(
            body=args.body,
    ...
    def get_choices(
        ...
        return self._get_choices_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class GetChoices(BaseApi):
    ...
    async def aget_choices(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ActionsGetChoicesResponsePydantic:
        raw_response = await self.raw.aget_choices(
            data=data,
            action=action,
            input=input,
            page=page,
        ...
        if validate:
            return ActionsGetChoicesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ActionsGetChoicesResponsePydantic, raw_response.body)
    ...
    def get_choices(
        ...
        raw_response = self.raw.get_choices(
            data=data,
            action=action,
            input=input,
            page=page,
